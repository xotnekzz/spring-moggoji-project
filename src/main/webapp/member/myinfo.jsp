...
<ASIDE style='float: left;'>
    MyPage > <A href='./member_list_search.do?&word=${param.word}&nowPage=${param.nowPage}'>내정보</A>  > 수정
  </ASIDE>
<br><br> 
  <FORM name='frm' method='POST' action='./mupdate.do' enctype="multipart/form-data">
 ...
 <%--  <input type='hidden' name='memail' id='memail' value='${memberVO.memail }'> --%>
  ...
  <div style="float: left; width: 60%; text-align: left; margin-top: 50px;" >
     <ul>
     <li class='li_none'>
        <label class='label_basic' for='name'>이메일</label>
        <input type='text' class="form-control input-lg" name='email' id='email' value="${memberVO.memail }"  disabled>
      <li class='li_none'>
