...
<DIV class='content' style="width: 70%; margin: 0px auto;">
  ...
  <ASIDE style='float: left;'>
     MyPage >  <A href='./a_movielist.do' >리뷰 목록</A>  
  </ASIDE>
  ...
  <TR>
    ...
    <TD class='td' style='vertical-align: middle;'><A href="./read.do?reviewno=${reviewVO.reviewno}">${reviewVO.title}</A></TD>
...
<%--     <TD class='td' style="text-align: center;"><a href="./show_hide.do=reviewno${reviewVO.reviewno}">${reviewVO.visible}</a></TD> --%>
    ...
    <TD class='td' style='vertical-align: middle; text-align: center;'>
      <A href="./update.do?reviewno=${reviewVO.reviewno}"><IMG src='./images/edit.png' style="width: 16px;" title='수정'></A>
      <A href="./delete.do?reviewno=${reviewVO.reviewno}"><IMG src='./images/trash.png' style="width: 16px;" title='삭제'></A>
    </TD>
