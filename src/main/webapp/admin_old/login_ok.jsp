...
<body>
  <DIV class='container'>
    ...
    <DIV class='content'>
        ...
        <DIV style='float: right; margin : 55px 100px 100px 0px;  border: solid 1px; padding : 20px 50px 32px 50px;'>
          <FORM name='frm' method='POST' action='./login_ck_proc.jsp' onsubmit="return send(this);" style="margin : 0px; float: left;">
            <input type="hidden" name="url_address" value="">
                <p style="font-weight: bold; font-size : 10px; color: #666;">　MEMBER LOGIN</p>
            <fieldset class='fieldset_no_line'>
              <ul>
                <li class='li_none'>
                <label for='email' style="border: solid 1px; color: #D3C9C9;">email　　
                <input type='email' name='email' id='email' value='' style='width: 50%; border:none; padding-right : 20px;' autocomplete="off"> 
                </label>
                </li>
                <li class='li_none'>
                <label for='passwd' style="border: solid 1px; color: #D3C9C9;">password
                <input type='password' name='passwd' id='passwd' value='' style='width: 50%; border:none; padding-right : 22px;' autocomplete="off"> 
                </label>
                </li>
                <li class='li_none'>
                <br>
                  <button type='submit' class="login_button">LOGIN</button>
                  <button type='button' onclick="history.back();" class="login_button">CANCEL</button>
                </li>
              </ul>
